...
if [ -z "${GAUDI_ROOT}" ]; then
   export GAUDI_ROOT=/cvmfs/atlas.cern.ch/repo/sw/software/21.2/GAUDI/21.2.65/InstallArea/x86_64-slc6-gcc62-opt
fi
...
if [ -z "${PYTHONPATH}" ]; then
   export PYTHONPATH=${ROOTSYS}/lib:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/python:${GAUDI_ROOT}/python:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/python
else
   export PYTHONPATH=${ROOTSYS}/lib:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/python:${GAUDI_ROOT}/python:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/python:${PYTHONPATH}
fi
if [ -z "${PATH}" ]; then
   export PATH=${ROOTSYS}/bin:${PYTHONHOME}/bin:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/bin:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/bin:${LCG_RELEASE_BASE}/LCG_94a/cairo/1.15.8/x86_64-slc6-gcc62-opt/bin:${LCG_RELEASE_BASE}/LCG_94a/graphviz/2.28.0/x86_64-slc6-gcc62-opt/bin:${LCG_RELEASE_BASE}/LCG_94a/doxygen/1.8.11/x86_64-slc6-gcc62-opt/bin
else
...
if [ -z "${LD_LIBRARY_PATH}" ]; then
   export LD_LIBRARY_PATH=${LCG_RELEASE_BASE}/LCG_94a/Boost/1.66.0/x86_64-slc6-gcc62-opt/lib::${LCG_RELEASE_BASE}/LCG_94a/Boost/1.66.0/x86_64-slc6-gcc62-opt/lib::::${LCG_RELEASE_BASE}/LCG_94a/tbb/2018_U1/x86_64-slc6-gcc62-opt/lib:${PYTHONHOME}/lib:${ROOTSYS}/lib:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/lib:${GAUDI_ROOT}/lib:/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.65/InstallArea/x86_64-slc6-gcc62-opt/lib:${LCG_RELEASE_BASE}/LCG_94a/cairo/1.15.8/x86_64-slc6-gcc62-opt/lib:${LCG_RELEASE_BASE}/LCG_94a/pango/1.40.13/x86_64-slc6-gcc62-opt/lib:${LCG_RELEASE_BASE}/LCG_94a/graphviz/2.28.0/x86_64-slc6-gcc62-opt/lib
else
