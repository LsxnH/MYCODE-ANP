#Fri Aug  3 20:11:05 2018"""Automatically generated. DO NOT EDIT please"""
...
class Ath__ReadElec( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'elecLooseLH' : PrivateToolHandle('IAsgElectronLikelihoodTool'), # GaudiHandle
    'elecLooseLHWithBL' : PrivateToolHandle('IAsgElectronLikelihoodTool'), # GaudiHandle
    'elecMediumLH' : PrivateToolHandle('IAsgElectronLikelihoodTool'), # GaudiHandle
    'elecTightLH' : PrivateToolHandle('IAsgElectronLikelihoodTool'), # GaudiHandle
...
class Ath__ReadMuon( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'trigEff2015Tools' : PrivateToolHandleArray([]), # GaudiHandleArray
    'trigEff2016Tools' : PrivateToolHandleArray([]), # GaudiHandleArray
    'mcTruthClassifier' : PublicToolHandle('MCTruthClassifier/MCTruthClassifier'), # GaudiHandle
  }
  _propertyDocDct = { 
    'DetStore' : """ Handle to a StoreGateSvc/DetectorStore instance: it will be used to retrieve data during the course of the job """,
